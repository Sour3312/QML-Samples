...
//        }
    ...
    Rectangle {
        ...
        Map {
            id: map
            anchors.fill: parent
//            anchors.topMargin: fullWindow ? 0 : Math.round(parent.height / 12)
//            anchors.leftMargin: fullWindow ? 0 : Math.round(parent.width / 12)
            anchors.margins: fullWindow ? 0 : Math.round(parent.width / 12)
            plugin: mapPlugin
