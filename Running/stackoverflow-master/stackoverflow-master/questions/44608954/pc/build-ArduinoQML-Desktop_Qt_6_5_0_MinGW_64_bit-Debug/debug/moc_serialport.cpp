...
#include "../../ArduinoQML/serialport.h"
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSSerialPortENDCLASS_t qt_meta_stringdata_CLASSSerialPortENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(11, 25),  // "oil_pressure_volt_Changed"
        QT_MOC_LITERAL(37, 0),  // ""
        QT_MOC_LITERAL(38, 8),  // "newValue"
        QT_MOC_LITERAL(47, 10),  // "onReadData"
        QT_MOC_LITERAL(58, 17)   // "oil_pressure_volt"
    },
    "SerialPort",
    "oil_pressure_volt_Changed",
    "",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSSerialPortENDCLASS[] = {
 ...
 // properties: name, type, flags
       5, QMetaType::Double, 0x00015003, uint(0), 0,
...
void SerialPort::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->oil_pressure_volt_Changed((*reinterpret_cast< std::add_pointer_t<double>>(_a[1]))); break;
        ...
        {
            using _t = void (SerialPort::*)(double );
            if (_t _q_method = &SerialPort::oil_pressure_volt_Changed; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< double*>(_v) = _t->get_oil_pressure_volt(); break;
        default: break;
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->set_oil_pressure_volt(*reinterpret_cast< double*>(_v)); break;
        default: break;
        }
...
// SIGNAL 0
void SerialPort::oil_pressure_volt_Changed(double _t1)
{
